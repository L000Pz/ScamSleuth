...
public class Report
{
    ...
    public static Report Create(string title,int writer_id, int scam_type_id, DateTime scam_date,DateTime report_date, decimal financial_loss, string description)
    {
        return new Report
        {
            title = title,
